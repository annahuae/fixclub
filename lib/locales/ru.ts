...
export const ru: Record<keyof typeof en, string> = {
  ...
  search_placeholder: 'Поиск мастера или компании...',
  all_emirates: 'Все эмираты',
  ...
  access_sign_in: 'Вход',
  access_sign_up: 'Регистрация',
  access_email: 'Email',
  access_password: 'Пароль',
  access_name: 'Имя',
  access_invite_code: 'Инвайт-код',
  access_no_account: 'Нет аккаунта?',
  access_have_account: 'Уже есть аккаунт?',
  access_password_hint: 'Сохрани — это твой пароль для входа.',

  profile_title: 'Профиль',
  profile_reviews_written: 'Написано отзывов',
  ...
  sort_newest: 'Свежие отзывы',

  reviews_heading: 'Отзывы',
  review_one_per: 'Один отзыв на мастера. Пиши по делу.',
  review_already_left: 'Ты уже оставил отзыв.',
  ...
  pending_body:
    'Когда админ одобрит — заходи по email и паролю. Обновление страницы не ускоряет процесс.',
  pending_back: '← К входу',

  map_open_in_google: 'Открыть в Google Maps',
